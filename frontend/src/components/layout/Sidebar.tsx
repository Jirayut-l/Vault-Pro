...
import { LayoutDashboard, Shield, ArrowRightLeft, Target, Settings, LogOut, Receipt } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { name: 'Vaults & Assets', href: '/dashboard/vaults', icon: Shield },
    { name: 'Scheduled', href: '/dashboard/scheduled', icon: ArrowRightLeft },
  ];
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 border-r border-slate-200 dark:border-slate-800/60 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl p-6 fixed left-0 top-0 h-screen z-40 transition-colors duration-300">
      <div className="flex items-center gap-3 mb-12">
        <div className="w-10 h-10 rounded-xl overflow-hidden shadow-[0_0_15px_rgba(16,185,129,0.4)] relative">
          <Image src="/logo.png" alt="Vault Pro Logo" fill className="object-cover" />
        </div>
